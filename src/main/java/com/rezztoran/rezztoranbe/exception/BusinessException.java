...
public class BusinessException extends RuntimeException {
  ...
  public enum Ex {
    ...
    PASSWORD_RESET_REQUEST_NOT_FOUND_EXCEPTION(
        "messages.error.password_reset_request_code_not_found_exception", HttpStatus.NOT_FOUND),

    /** Password reset request code wrong exception ex. */
    PASSWORD_RESET_REQUEST_CODE_WRONG_EXCEPTION(
        "messages.error.password_reset_request_code_wrong_exception", HttpStatus.NOT_FOUND),

    /** Password reset request code expired exception ex. */
    PASSWORD_RESET_REQUEST_CODE_EXPIRED_EXCEPTION(
        "messages.error.password_reset_request_code_expired_exception", HttpStatus.NOT_FOUND),
